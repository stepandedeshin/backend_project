...
class APIException:
    ...
    UNAUTHORIZED = HTTPException(status_code=status.HTTP_401_UNAUTHORIZED, detail="Администратор не авторизован")
    ...
    USER_EXISTS = HTTPException(status_code=status.HTTP_409_CONFLICT, detail="Пользователь уже существует")